...
Zenith Culinaria 是一款 **AI 驱动的智能厨房助手**，根据用户冰箱中的真实食材库存，结合个人口味偏好和忌口设置，通过 **两阶段 AI 推荐算法**（本地规则预筛 + 大模型精排）智能推荐菜谱，并支持一键烹饪、自动扣减库存的完整闭环。

### 🎯 核心理念

> 市面上的菜谱产品都是 **"人找菜谱"**，Zenith Culinaria 实现的是 **"菜谱找人"**——基于用户真实库存和个人偏好，由 AI 主动推荐最合适的菜谱。
